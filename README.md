[![MATLAB](https://github.com/gfroessilva/ci-configuration-examples/actions/workflows/ci.yml/badge.svg)](https://github.com/gfroessilva/ci-configuration-examples/actions/workflows/ci.yml)
